...
def generate_hybrid_playlist():
    ...
    for channel in channel_data_list_signed:
    	channel['link']=aynaott.hmac_hash_sign(channel["stream_url"],'ferdflix',user_ip_addr,akamai_key)
...
def generate_ns_player_playlist():
    ...
    channel_data_list_signed = copy.deepcopy(channels_data_list)
    for channel in channel_data_list_signed:
    	channel['link']=aynaott.hmac_hash_sign(channel["stream_url"],'fredflix',user_ip_addr,akamai_key)
...
def generate_stream_url():
    ...
    stream_url_signed=aynaott.hmac_hash_sign(stream_url,'fredflix',user_ip_addr,akamai_key)
